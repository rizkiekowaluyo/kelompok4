...
<head>
    ...
    <link href="<?php echo base_url().'asset/admin/css/themes/all-themes.css'?>" rel="stylesheet" />
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Bengkelin</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="info-container">
                    ...
                    <div class="email"><?php echo $_SESSION['username'];?>@gmail.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo site_url('admin/additem')?>">Add Items</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('admin/seeitem')?>">See list item</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="<?php echo site_url('admin/addarticle') ?>">Add Blog</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('admin/seearticle') ?>">See Article</a>
                            </li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - 2018 <a href="javascript:void(0);">Bengkelin - Purchase Item</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
